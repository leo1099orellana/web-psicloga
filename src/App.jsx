...
import { 
  ...
  Building2, Cloud, HeartCrack, Sunrise, MapPin, Globe, CheckCircle2, Mail
} from 'lucide-react';
...
function TarjetaEspecialidad({ icono, titulo, descripcion }) {
  return (
    ...
    <div className="bg-white p-10 rounded-[2rem] shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 flex flex-col text-left group cursor-default">
...
function TarjetaTrayectoria({ icono, categoria, titulo, descripcion, alineacion }) {
  ...
  return (
    <div className="relative flex items-center w-full mb-12 md:mb-16 last:mb-0 group cursor-default">
      <div className="absolute left-6 md:left-1/2 transform md:-translate-x-1/2 flex items-center justify-center w-12 h-12 bg-[#E3878D] rounded-full border-[4px]
       border-[#FCF6F0] shadow-sm z-10 text-white transition-transform duration-300 group-hover:scale-110 group-hover:bg-[#D1767C]">
        {icono}
      </div>
      <div className={`w-full pl-24 md:pl-0 md:w-1/2 ${esIzquierda ? 'md:pr-16 md:text-right' : 'md:ml-auto md:pl-16 text-left'}`}>
        {/* Tarjeta blanca para que resalte sobre el fondo cremita */}
        <div className="bg-white border border-gray-100/50 p-8 md:p-10 rounded-[2rem] shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 w-full inline-block hover:border-[#E3878D]/20">
          <p className="text-[11px] text-[#E3878D] font-bold tracking-[0.2em] uppercase mb-2">
            {categoria}
          </p>
          <h4 className="text-2xl text-[#8A2742] mb-4 font-medium">
            {titulo}
          </h4>
...
export default function App() {
  ...
  return (
    // Fondo cremita claro para TODA la aplicación
    <div className='min-h-screen font-sans text-gray-700 relative pb-0 bg-[#FCF6F0]'>
      <style>
        {`@import url('https://fonts.googleapis.com/css2?family=Dancing+Script:wght@400;600&display=swap');`}
      </style>

      {/* PARTE DE ARRIBA PRINCIPAL */}
      <header className='sticky top-0 z-50 bg-[#FCF6F0]/90 backdrop-blur-md py-4 px-8 lg:px-24 flex justify-between items-center transition-all border-b border-[#8A2742]/5'>
        <div className='flex items-center gap-3 cursor-pointer'>
          <div className='w-14 h-14 rounded-full bg-[#E3878D] p-[3px] shadow-sm flex-none flex items-center justify-center'>
            <div className='w-full h-full border-[1.5px] border-white rounded-full flex items-center justify-center'>
              <HeartPulse size={22} className="text-white" strokeWidth={1.5} />
            </div>
          </div>
          <div className='flex flex-col items-end mt-1'>
            <h1 className='text-[#D1767C] text-2xl leading-none pr-1 tracking-tight' style={{ fontFamily: "'Dancing Script', cursive", fontWeight: 600 }}>
              Lic. Melanie Chaffittelli
            </h1>
            <span className='bg-[#E3878D] text-white text-[9px] px-3 py-1 rounded-sm uppercase mt-1 font-bold shadow-sm tracking-widest'>
              Psicóloga
            </span>
          </div>
        </div>
      ...
      <main>
        {/* SECCION: 1 INICIO */}
        <div id="inicio" className="w-full pt-16 pb-24 relative overflow-hidden">
          ...
          <div className='max-w-7xl mx-auto px-6 lg:px-12 relative z-10'>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[60vh]'>
              <div className='order-2 lg:order-1 flex flex-col items-center lg:items-start text-center lg:text-left'>
                ...
                <h2 className='text-6xl lg:text-8xl text-[#8A2742] mb-8 leading-[0.85]' style={{ fontFamily: "'Dancing Script', cursive", fontWeight: 400 }}>
                  Lic. Melanie <br />
                  <span className='text-[#D1767C]'>Chaffittelli</span>
                </h2>
                <p className='text-lg lg:text-xl text-[#8A2742]/70 mb-10 leading-relaxed max-w-lg'>
                ...
                <div className='flex flex-col sm:flex-row gap-6 w-full lg:w-auto'>
                  <a href={whatsappLink} target="_blank" rel="noreferrer" className='cursor-pointer bg-[#D1767C] text-white py-4 px-10 rounded-full font-medium shadow-lg hover:scale-105 transition-all'>
                    Solicitar Turno →
                  </a>
                  <a href="#modalidad" className="cursor-pointer bg-white text-[#8A2742] border border-[#8A2742]/10 py-4 px-10 rounded-full font-medium shadow-sm hover:bg-gray-50 transition-all">
                    Ver Modalidad
                  </a>
                </div>
              </div>
              <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
                <div className="relative group">
                  {/* Tarjeta blanca (Polaroid) para la foto */}
                  <div className="bg-white w-full max-w-md aspect-[4/5] rounded-[4rem] p-4 shadow-xl flex items-center justify-center relative overflow-hidden">
        ...
        <section id='recorrido' className='w-full py-24'>
          <div className='max-w-4xl mx-auto px-6'>
            <div className="text-center mb-16">
              <p className='text-[#E3878D] text-xs font-bold tracking-[0.2em] uppercase mb-4'>
                MI RECORRIDO
              </p>
              <h3 className="text-4xl md:text-5xl text-gray-700 font-light mb-8">
            ...
            <div className='text-left relative space-y-6 text-gray-500 leading-relaxed font-light text-base md:text-lg'>
              <p className="mb-6">
                <span className="text-3xl text-gray-800 mr-2" style={{ fontFamily: "'Dancing Script', cursive" }}>¡Hola! Soy Melanie.</span>
        ...
        <section id="trayectoria" className="max-w-5xl mx-auto mt-32 relative z-10">
          <div className="text-center mb-20">
            <p className="text-[#E3878D] text-xs font-bold tracking-[0.2em] uppercase mb-4">
              TRAYECTORIA PROFESIONAL
            </p>
            <h3 className="text-4xl md:text-5xl text-gray-700 font-light">
              Formación Académica y Clínica
            </h3>
          </div>
          <div className="relative py-4">
            <div className="absolute left-[3rem] md:left-1/2 transform md:-translate-x-1/2 top-0 bottom-0 w-[2px] bg-[#E3878D]/20 -z-10"></div>
        ...
        {/* ============================================================== */}
        <section id="especialidades" className="w-full py-24 mt-24">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="text-center mb-16">
              ...
              <h3 className="text-4xl md:text-5xl text-gray-700 font-light mb-6">Abordajes Clínicos</h3>
        ...
        {/* ============================================================== */}
        {/* SECCIÓN 5: MODALIDAD DE CONSULTA (ATENCIÓN)                    */}
        {/* ============================================================== */}
        <section id="modalidad" className="w-full py-24 border-t border-[#8A2742]/5">
          <div className="max-w-5xl mx-auto px-6">
            
            <div className="text-center mb-16">
              <p className="text-[#E3878D] text-xs font-bold tracking-[0.2em] uppercase mb-4">ATENCIÓN</p>
              <h3 className="text-4xl md:text-5xl text-gray-700 font-light mb-6">Modalidad de Consulta</h3>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              
              {/* TARJETA PRESENCIAL */}
              <div className="bg-white border border-gray-100/50 p-10 md:p-12 rounded-[2.5rem] shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 relative overflow-hidden group cursor-default">

                <MapPin size={160} className="absolute -top-6 -right-6 text-[#E3878D]/5 group-hover:scale-110 transition-transform duration-500" strokeWidth={1} />
                ...
                <div className="relative z-10">
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-center gap-3 text-gray-600 font-light text-[15px]">
              ...
              {/* TARJETA ONLINE */}
              <div className="bg-[#E3878D] p-10 md:p-12 rounded-[2.5rem] shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 relative overflow-hidden group cursor-default">

                <Globe size={160} className="absolute -top-6 -right-6 text-white/10 group-hover:scale-110 transition-transform duration-500" strokeWidth={1} />
                ...
                <div className="relative z-10">
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-center gap-3 text-white/90 font-light text-[15px]">
      ...
      {/* SECCION WAP E EMAIL                       */}
      {/* ============================================================== */}
      <footer id="contacto" className="w-full pt-20 pb-12 relative border-t border-[#8A2742]/5">
        <div className="max-w-4xl mx-auto px-6 text-center">
          
          <h3 className="text-3xl md:text-4xl text-gray-700 font-light mb-4">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-16">
            ...
            <a href="mailto:lic.melaniech@gmail.com" className="flex items-center gap-2 bg-white text-[#8A2742] font-medium py-3 px-8 rounded-full shadow-sm hover:bg-gray-50 border border-gray-100 hover:scale-105 transition-all cursor-pointer w-full sm:w-auto justify-center">
              <Mail size={18} />
              lic.melaniech@gmail.com
            </a>
          </div>

          {/* LINEA SEPARADORA AL FINAL */}
      ...
      <a 
        ...
        target="_blank" 
        rel="noreferrer" 
        className="fixed bottom-8 right-8 bg-[#E3878D] text-white p-4 lg:p-5 rounded-full shadow-2xl hover:scale-110 hover:bg-[#D1767C] transition-all z-50 flex items-center justify-center cursor-pointer"
      >
